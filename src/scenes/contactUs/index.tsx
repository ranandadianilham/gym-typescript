    ...
    <section id="contact" className='mx-auto w-5/6 pt-24 pb-32'>
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Contact)}>
            ...
            >
                ...
                <p className='my-5'>
                Nulla velit magna, blandit eu libero a, blandit vulputate sem. Cras efficitur leo eu faucibus cursus. Quisque mattis erat dapibus, ultrices enim id, auctor lacus. 
                </p>
            </motion.div>
            ...
            <div className='mt-10 justify-between gap-8 md:flex'>
                ...
                >
                    ...
                    onSubmit={onSubmit}
                    method={"POST"}
                    action="https://formsubmit.co/c35c0d7c1d02fc6cde844da91edeee7a"
                    >
                        <input 
